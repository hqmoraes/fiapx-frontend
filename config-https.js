...
const CONFIG = {
    ...
    AUTH_SERVICE_URL: 'https://fiapx.wecando.click/api/auth',
    UPLOAD_SERVICE_URL: 'https://fiapx.wecando.click/api/upload', 
    PROCESSING_SERVICE_URL: 'https://fiapx.wecando.click/api/processing',
    STORAGE_SERVICE_URL: 'https://fiapx.wecando.click/api/storage',
    ...
    API_BASE_URL: 'https://fiapx.wecando.click/api',
